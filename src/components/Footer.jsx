...
function Footer() {
  return (
    <>
    <div className="flex gap-[10vw] text-[#fff] w-full h-screen bg-zinc-900 p-16">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[8vw] uppercase leading-none font-bold tracking-tight">
            Eye-
          </h1>
          <h1 className="text-[8vw] uppercase leading-none font-bold tracking-tight">
            Opening
      ...
      <div className=" w-1/2 flex relative">
        ...
        <h1 className="text-[5.5vw] uppercase leading-none font-bold tracking-tight">
          Presentations
        </h1>
        ...
        <div className="dets mt-10">
          <h1>M :</h1>
            ...
            <a className="block text-xl font-light" href="">Outwork</a>
            <a className="block text-xl font-light" href="">About Us</a>
            <a className="block text-xl font-light" href="">Insight</a>
